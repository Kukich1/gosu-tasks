            ...
            <div class="modal">
                ...
                <div class="comment_container">
                    ...
                    <div class="comment_add_button_container">
                        <button @click="addComment" class="comment_add_button">Отправить</button>  
                    </div>
                </div>
    ...
    methods: {
        ...
        async addComment() {
            try {
                ...
                const response = await axios.post(`https://gosutasks-api.vercel.app/admin/add_comment/${this.taskId}`, {
