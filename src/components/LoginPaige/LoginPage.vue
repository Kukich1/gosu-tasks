  ...
  <div class="wrapper">
    <div class="left">
      <div v-show="isLoading === false" class="logo-container">
        <img src="./images/tasks.svg" alt="Что-то пошло не так братик!" />
      </div>
    ...
    <div class="right"><img src="./images/Ресурс121@2x.png" /></div>
  </div>
</template>
  ...
  methods: {
    async onSubmit() {
      ...
      try {
        ...
        const response = await axios.post('https://gosutasks-api.vercel.app/user/login/', postData)
        console.log
...
body,
html {
  background-image: url('./images/Ресурс121@2x.png');
